      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 items-end">
          ...
          <p className="text-charcoal/70 text-sm leading-relaxed">
            Tổng quy mô sản phẩm khoảng <span className="text-cta-orange font-bold text-lg">1.111</span> căn
            ...
            <div key={product.id}>
              ...
              <ul className="space-y-1.5 mb-3">
                <li className="flex items-baseline gap-2 text-sm text-charcoal/80">
                  <span className="text-cta-orange font-bold">✦</span>
                  Khoảng <span className="text-cta-orange font-bold text-lg">{product.quantity.replace('~', '')}</span>
                </li>
                <li className="flex items-baseline gap-2 text-sm text-charcoal/80">
                  <span className="text-cta-orange font-bold">✦</span>
                  {product.maxFloors}
